...
use App\Http\Requests\StoreUdateCommentRequest;
...
class CommentController extends Controller
{
    ...
    public function store(StoreUdateCommentRequest $request, $userId)
    {
        if (!$user = $this->user->find($userId)) {
            return redirect()->back();
        }
    ...
    public function update(StoreUdateCommentRequest $request, $id)
    {
        if (!$comment = $this->comment->find($id)) {
            return redirect()->back();
        }
